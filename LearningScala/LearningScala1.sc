object LearningScala1 {
  ...
  val hello: String = "Jean!"                     //> hello  : String = Jean!
  println(hello)                                  //> Jean!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Jean!
  helloThere = hello + " There!"
  println(helloThere)                             //> Jean! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Jean!There!
  println(immutableHelloThere)                    //> Jean!There!
